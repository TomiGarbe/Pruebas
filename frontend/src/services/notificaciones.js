...
export const deleteSubscription = (endpoint) => api.delete('/push/unsubscribe', { data: endpoint });
...
export const delete_notificacion = (id_notificacion) => api.delete(`/notificaciones/${id_notificacion}`);