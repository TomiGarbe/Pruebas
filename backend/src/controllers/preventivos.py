...
def preventivo_create(preventivo: PreventivoCreate, db: Session = Depends(get_db)):
    new_preventivo = create_preventivo(db, preventivo.id_sucursal, preventivo.nombre_sucursal, preventivo.frecuencia)
    return {"id": new_preventivo.id, "id_sucursal": new_preventivo.id_sucursal, "nombre_sucursal": preventivo.nombre_sucursal, "frecuencia": new_preventivo.frecuencia}
...
def preventivo_update(preventivo_id: int, preventivo: PreventivoUpdate, db: Session = Depends(get_db)):
    updated_preventivo = update_preventivo(db, preventivo_id, preventivo.id_sucursal, preventivo.nombre_sucursal, preventivo.frecuencia)
    return {"id": updated_preventivo.id, "id_sucursal": updated_preventivo.id_sucursal, "nombre_sucursal": preventivo.nombre_sucursal, "frecuencia": updated_preventivo.frecuencia}
