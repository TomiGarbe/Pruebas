...
def cuadrilla_create(cuadrilla: CuadrillaCreate, db: Session = Depends(get_db)):
    new_cuadrilla = create_cuadrilla(db, cuadrilla.nombre, cuadrilla.zona, cuadrilla.email)
...
def cuadrilla_update(cuadrilla_id: int, cuadrilla: CuadrillaUpdate, db: Session = Depends(get_db)):
    updated_cuadrilla = update_cuadrilla(db, cuadrilla_id, cuadrilla.nombre, cuadrilla.zona, cuadrilla.email)
