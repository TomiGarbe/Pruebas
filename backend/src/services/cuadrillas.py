...
def create_cuadrilla(db: Session, nombre: str, zona: str, email: str):
...
def update_cuadrilla(db: Session, cuadrilla_id: int, nombre: str = None, zona: str = None, email: str = None):
